...
function Sidebar() {
    ...
    return (
        <>
            <div className="sidebar bg-dark d-flex flex-column p-4 d-none d-md-block">
                <div className="sidebar-header my-4">
                    <h2 className='text-white'>Admin Panel</h2>
                </div>
                <div className='py-2 d-flex justify-content-center gap-3'>
                    <div>
                        <img src={"data:image/jpeg;base64,"}
                            className='img-fluid object-fit-cover border border-white border-2 shadow rounded-circle'
                            alt=""
            ...
            >
                ...
                <Offcanvas.Body className="mx-2">
                    ...
                    <div className='logout-btn'>
                        <button
                            type="button"
                            className="btn btn-warning fw-bold rounded"
                            onClick={logout}
                        >
                            Log Out
                        </button>
            ...
            <div className="d-md-none mb-3 position-fixed top-0 start-50 translate-middle-x p-2 z-index-999 w-100 bg-white d-flex justify-content-between align-items-center">
                <TiThMenu
